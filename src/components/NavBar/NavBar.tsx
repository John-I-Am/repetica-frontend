...
const NavBar = () => {
  ...
  const handleMouseEnter = (id: any) => {
    ...
    element.style.borderRight = 'solid 3px purple';
  ...
  return (
    <div id="navBar">
      <div id="toast" />
      <div id="navMain">
        <div id="home-nav" onMouseEnter={() => handleMouseEnter('home-nav')} onMouseLeave={() => handleMouseLeave('home-nav')}>
          <svg width="28" height="32" fill="none" viewBox="0 0 24 24">
      ...
      <div id="logout" onMouseEnter={() => handleMouseEnter('logout')} onMouseLeave={() => handleMouseLeave('logout')}>
        <svg onClick={handleLogout} width="28" height="28" fill="none" viewBox="0 0 24 24">
